...
import com.clientService.model.Appointment;
...
import com.clientService.model.RescheduleAppointmentDTO;
...
public class AppointmentController {
	...
	public String timeslotAppointment(@PathVariable Long patientId, @PathVariable Long doctorId,
		...
		String url = "http://localhost:8080/api/availability/time-slots";
		String url1 = "http://localhost:8080/api/doctors/" + doctorId;
		try {
	...
	public String scheduleAppointment(@PathVariable int patientId, @PathVariable int doctorId,
		...
		String url1 = "http://localhost:8080/api/availability/schedule";
	...
	public String cancelAppointment(@PathVariable Long patientId, @PathVariable Long appointmentId,
		...
		String url1 = "http://localhost:8080/patient/" + patientId + "/appointments/" + appointmentId;
		String url2 = "http://localhost:8080/api/availability/cancel";
...
//				List<Appointment> appointments = responseAppointment.getBody();
//				
//				Appointment singleAppointment = appointments.stream()
//						.filter(appointment -> appointment.getAppointmentId() == appointmentId).findFirst()
//						.orElseThrow(() -> new RuntimeException("Appointment not found for id: " + appointmentId));
	...
	public String rescheduleAppointment(@PathVariable int patientId, @PathVariable int appointmentId,
		...
		String url1 = "http://localhost:8080/patient/" + patientId + "/appointments/" + appointmentId;
		String url2 = "http://localhost:8080/api/availability/schedule";
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.set("Content-Type", "application/json");
